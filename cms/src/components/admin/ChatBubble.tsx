          ...
          <div ref={scrollRef} className="sb-chat-messages">
            {messages.length === 0 && !streaming && (
              <div className="sb-chat-empty">
                <div className="sb-chat-empty-icon" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#38bdf8" strokeWidth="1.75">
