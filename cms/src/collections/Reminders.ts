      ...
      fields: [
        {
          ...
          options: [
            { label: "Sự kiện độc lập (Standalone)", value: "standalone" },
            { label: "Liên kết đơn / đối tác (Linked)", value: "linked" },
          ],
          admin: { width: "33%" },
        },
        {
      ...
      fields: [
        ...
        },
        {
          ...
          options: [
            ...
            { label: "Quản lý sản xuất (Manager)", value: "manager" },
            { label: "Điều phối (Planner)", value: "planner" },
            { label: "Kinh doanh (Sales)", value: "salesperson" },
            { label: "Kiểm định KCS (QC)", value: "qc" },
            { label: "Thủ kho (Storage)", value: "storage" },
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: "Đã gửi thông báo", value: "sent" },
