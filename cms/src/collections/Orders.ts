              ...
              fields: [
                {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      required: true,
                      defaultValue: "PE",
                      admin: { width: "33%", description: "Mã thương hiệu / dự án. vd: PE/VN/JP" },
                    },
                  ],
                },
                {
                  ...
                  fields: [
                    {
                      ...
                      required: true,
                      min: 0,
                      admin: { width: "25%", description: "Tổng giá trị đơn (USD)" },
                    },
                    {
                      name: "deposit",
                      label: "Cọc ($)",
                      ...
                      defaultValue: 0,
                      min: 0,
                      admin: { width: "25%", description: "Số tiền khách đã đặt cọc" },
                    },
                    {
                      name: "owedAmount",
                      label: "Nợ ($)",
